...
namespace AlterEyes.UI.Demo
{
    ...
    /// </summary>
    [AddComponentMenu("AlterEyes/UI/Demo/Showcase Director")]
    public class ShowcaseDirector : MonoBehaviour
    {
        ...
        private void BindHudWidgets()
        {
            ...
            if (hud == null)
            {
                Debug.LogWarning("[AlterEyes.UI] ShowcaseDirector: no Game/HUD view in the scene — HUD simulation off", this);
                return;
            }
