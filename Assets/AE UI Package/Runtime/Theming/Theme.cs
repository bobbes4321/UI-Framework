...
namespace AlterEyes.UI
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "AlterEyes/UI/Theme", fileName = "Theme")]
    public class Theme : ScriptableObject
    {
        ...
        [Tooltip("Named surface styles (radius/border/softness) applied to AEShapes by ThemeShapeStyleTarget")]
        ...
        public Color GetColor(string token)
        {
            ...
            Debug.LogWarning($"[AlterEyes.UI] Theme '{name}' has no token '{token}' in variant '{activeVariantName}'", this);
            return Color.white;
        }
