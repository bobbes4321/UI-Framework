...
namespace AlterEyes.UI
{
    ...
    /// fill a bar with an AEShape pill, so the fill keeps rounded caps that an Image fillAmount
    /// can't give. Below the cap width the fill hides (a pill thinner than it is tall reads as
    /// a glitch); at zero it hides too.
    /// </summary>
    [AddComponentMenu("AlterEyes/UI/Progress Targets/Rect Fill Progress Target")]
