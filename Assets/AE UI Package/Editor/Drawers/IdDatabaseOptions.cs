...
namespace AlterEyes.UI.Editor
{
    ...
    /// AEUISettings. Lists are built when a dropdown opens — never per frame — and "add new" writes
    ...
    public static class IdDatabaseOptions
    {
        ...
        {
            AEGUI.SplitHorizontal(rect, out Rect categoryRect, out Rect nameRect);

            AEDropdown.StringPopup(categoryRect, categoryProperty,
                () => Categories(database),
            ...
            AEDropdown.StringPopup(nameRect, nameProperty,
