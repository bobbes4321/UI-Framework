...
namespace AlterEyes.UI.Editor
{
    ...
    [CustomEditor(typeof(AEShape)), CanEditMultipleObjects]
    public class AEShapeEditor : AEUIEditor
    {
        ...
        protected override string HeaderSubtitle => ((AEShape)target).shape.ToString();
        protected override Color Accent => AEColors.Rendering;
    ...
    [CustomEditor(typeof(AEGradient)), CanEditMultipleObjects]
    public class AEGradientEditor : AEUIEditor
    {
    ...
    public class ThemeTextStyleTargetEditor : AEUIEditor
    {
        ...
        protected override void DrawBody()
        {
            ...
            AEDropdown.StringPopup(rect, styleProperty, StyleOptions, "(no style)", AddStyleToTheme);
    ...
    public class ThemeShapeStyleTargetEditor : AEUIEditor
    {
