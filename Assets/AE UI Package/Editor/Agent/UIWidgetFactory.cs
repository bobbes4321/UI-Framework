...
namespace AlterEyes.UI.Editor
{
    ...
    /// AEShape-based (no sprites), theme-bound (color tokens + shape styles by name) and wired to
    ...
    public static class UIWidgetFactory
    {
        ...
        public static AEShape AddShape(GameObject go, ShapeType shape, float radius = 12f,
            string fillToken = null, string style = null, bool styleOwnsFill = true)
        {
            var aeShape = go.AddComponent<AEShape>();
            aeShape.shape = shape;
        ...
        /// under AEUI Generated/Materials and are keyed by font + color + width, so prefabs keep
        ...
        public static void ApplyTextOutline(TMP_Text text, Color color, float width)
        {
            ...
            const string dir = "Assets/AEUI Generated/Materials";
            if (!AssetDatabase.IsValidFolder(dir))
            {
                if (!AssetDatabase.IsValidFolder("Assets/AEUI Generated"))
                    AssetDatabase.CreateFolder("Assets", "AEUI Generated");
                AssetDatabase.CreateFolder("Assets/AEUI Generated", "Materials");
            }
            ...
            string colorToken = TokenTextDefault, string name = IconName)
        {
            ...
            {
                Debug.LogWarning($"[AlterEyes.UI] Unknown icon '{iconName}' — using 'circle-help'. " +
            ...
            TMP_FontAsset iconFont = FontAssetBootstrap.EnsureIconFont(AEUISettings.instance);
        ...
        public static GameObject CreateBadge(GameObject widget, int count)
        {
            ...
            AEShape pill = AddShape(go, ShapeType.Pill, fillToken: TokenDanger);
            ...
            string icon = null, string variant = VariantPrimary, string size = SizeMedium)
        {
            ...
            AEShape shape = variant == VariantGhost
        ...
        public static GameObject CreateToggle(RectTransform parent, string category, string name, string label)
        {
            ...
            AEShape boxShape = AddShape(box, ShapeType.RoundedRect, 8f, style: StyleControl, styleOwnsFill: false);
            ...
            check.GetComponent<AEShape>().raycastTarget = false;
        ...
        public static GameObject CreateSwitch(RectTransform parent, string category, string name)
        {
            ...
            AEShape trackShape = AddShape(track, ShapeType.Pill);
            ...
            AEShape knobShape = AddShape(knob, ShapeType.Circle);
            ...
            float min = 0f, float max = 1f, float value = 0.5f)
        {
            ...
            fill.GetComponent<AEShape>().raycastTarget = false;
            ...
            AEShape handleShape = AddShape(handle, ShapeType.Circle, fillToken: TokenTextStrong);
            ...
            float? value = null)
        {
            ...
            // sprite-free fill: an AEShape pill spanning anchors 0..progress keeps rounded caps
            ...
            AEShape fillShape = AddShape(fill, ShapeType.Pill, fillToken: TokenPrimary);
            ...
            float? value = null)
        {
            ...
            AEShape track = AddShape(go, ShapeType.Ring, fillToken: TokenSurfaceElevated);
            track.ringThickness = 10f;

            GameObject fill = CreateRect((RectTransform)go.transform, FillName, Vector2.zero, "Stretch");
            AEShape arc = AddShape(fill, ShapeType.Arc, fillToken: TokenPrimary);
            ...
            string variant = null)
        {
            ...
            AEShape tabShape = AddShape(go, ShapeType.RoundedRect, 10f);
        ...
        /// <summary>
        /// Builds the standardized drop-shadow sibling (a stretched soft AEShape behind the
        ...
        public static GameObject WithElevation(GameObject go, int level)
        {
            ...
            AEShape shadowShape = shadow.GetComponent<AEShape>();
            if (shadowShape == null)
        ...
        public static GameObject CreatePopupShell(string popupName, Vector2 size, out RectTransform content)
        {
            ...
            AEShape overlayShape = AddShape(overlay, ShapeType.RoundedRect, 0f, fillToken: TokenShadow);
        ...
        public static GameObject CreateTooltip(string text = "Tooltip")
        {
            ...
            AEShape shape = AddShape(card, ShapeType.RoundedRect, 10f, fillToken: TokenSurfaceElevated);
            shape.border = 1f;
        ...
        /// (collapsed caption + arrow, an inactive scrollable item template) entirely from AEShape so
            ...
            IReadOnlyList<string> options, int value = 0)
        {
            ...
            AEShape itemBgShape = AddShape(itemBg, ShapeType.RoundedRect, 6f, fillToken: TokenSurfaceElevated);
            ...
            AEShape itemCheckShape = AddShape(itemCheck, ShapeType.Checkmark, fillToken: TokenPrimary);
