...
namespace AlterEyes.UI.Editor
{
    ...
    /// Tools → AlterEyes UI → Apply Theme Bundle.
    /// </summary>
    public static class ThemeBundles
    {
        ...
        /// </summary>
        public static void Apply(Bundle bundle, AEUISettings settings, GenerateReport report)
        {
        ...
        /// </summary>
        private static void ApplyMotion(Bundle bundle, AEUISettings settings, GenerateReport report)
        {
        ...
        private static void ApplyMotionPreset(AEUISettings settings, GenerateReport report, PresetSpec presetSpec)
        {
            const string folder = UISpecGenerator.GeneratedRoot + "/Presets";
        ...
        [MenuItem("Tools/AlterEyes UI/Apply Theme Bundle/Clean Slate", priority = 110)]
        public static void ApplyCleanSlateMenu() => ApplyFromMenu(CleanSlate);

        [MenuItem("Tools/AlterEyes UI/Apply Theme Bundle/Neon Arcade", priority = 111)]
        public static void ApplyNeonArcadeMenu() => ApplyFromMenu(NeonArcade);

        [MenuItem("Tools/AlterEyes UI/Apply Theme Bundle/Soft Fantasy", priority = 112)]
        ...
        private static void ApplyFromMenu(Bundle bundle)
        {
            ...
            Apply(bundle, AEUISettingsBootstrap.GetOrCreateSettings(), report);
            Debug.Log($"[AlterEyes.UI] {report}");
        }
    }
}
