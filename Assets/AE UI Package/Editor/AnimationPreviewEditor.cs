...
namespace AlterEyes.UI.Editor
{
    ...
    public class UIAnimatorEditor : UnityEditor.Editor
    {
        ...
        {
            AEGUI.ComponentHeader("UIAnimator", null, AEColors.Animation);
    ...
    public class UIContainerUIAnimatorEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            AEGUI.ComponentHeader("Container UI Animator", null, AEColors.Animation);
            DrawDefaultInspector();
    ...
    public class UISelectableUIAnimatorEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            AEGUI.ComponentHeader("Selectable UI Animator", null, AEColors.Animation);
            DrawDefaultInspector();
    ...
    public class UIToggleUIAnimatorEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            AEGUI.ComponentHeader("Toggle UI Animator", null, AEColors.Animation);
            DrawDefaultInspector();
