...
namespace AlterEyes.UI.Tests
{
    ...
    /// (free-anchored children inside layout cells), image "src" sprite fills riding AEShape
    ...
    {
        private const string ArtFolder = "Assets/AEUITestArt";
        ...
        public void CreateSpriteAsset()
        {
            if (!AssetDatabase.IsValidFolder(ArtFolder))
                AssetDatabase.CreateFolder("Assets", "AEUITestArt");
        ...
        public void Overlay_HostsFreeAnchoredChildren_WithDecor()
        {
            ...
            var decor = overlay.GetComponent<AEShape>();
            ...
            var badge = (RectTransform)overlay.GetComponentsInChildren<AEShape>(true)
            ...
            var art = (RectTransform)overlay.GetComponentsInChildren<AEShape>(true)
        ...
        public void ImageSrc_RidesAEShape_WithRoundedCorners()
        {
            ...
            AEShape art = prefab.GetComponentsInChildren<AEShape>(true).First(s => s.sprite != null);
        ...
        public void TransparentScroll_StripsBacking_AndRoundTrips()
        {
            ...
            Assert.IsNull(scroll.GetComponent<AEShape>(), "background 'none' strips the card backing");
        ...
        public void RichPopup_BuildsElements_CloseButton_AndSlots()
        {
            ...
            Assert.IsInstanceOf<AEShape>(popup.images[0]);
