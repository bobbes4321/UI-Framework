...
namespace AlterEyes.UI.Tests
{
    ...
    public class SpecLayoutAndWidgetTests
    {
        ...
        public void LayoutContainers_GenerateLayoutGroups()
        {
            ...
            Assert.AreEqual(2, grid.GetComponentsInChildren<AEShape>(true).Length, "two shapes in the grid");
        ...
        public void Widgets_GenerateFunctionalHierarchies()
        {
            ...
            Assert.IsNotNull(button.GetComponent<AEShape>(), "buttons are AEShape-based");
        ...
        public void Popups_Generate_AndRegister()
        {
            ...
            Assert.AreEqual(prefab, AEUISettings.instance.popupDatabase.GetPrefab("SpecConfirm"),
        ...
        public void StarterKit_CreatesThemedPrefabLibrary()
        {
            ...
            Assert.IsTrue(card.GetComponentsInChildren<AEShape>(true).Length >= 2, "card has shadow + surface shapes");
        ...
        public void Screenshotter_WritesPng()
        {
            ...
            string path = UIScreenshotter.Capture(prefab, $"Temp/aeui-screenshots/test-button.png", 480, 320);
