...
{
    /// <summary>
    /// Builds a self-contained showcase scene at Assets/Scenes/NeoUIDemo.unity:
    ...
    {
        private const string ScenePath = "Assets/Scenes/NeoUIDemo.unity";
        private const string DemoFolder = "Assets/Neo UI Framework/Demo";
        ...
        [MenuItem("Tools/Neo UI/Create Demo Scene", priority = 50)]
        public static void CreateDemoScene()
        {
            if (!EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo()) return;
            BuildDemoScene();
            EditorSceneManager.OpenScene(ScenePath);
            Debug.Log($"[Neo.UI] Demo scene created at {ScenePath} — press Play.");
        }

        /// <summary> Batch entry point: -executeMethod Neo.UI.Editor.DemoSceneBuilder.BuildDemoScene </summary>
        public static void BuildDemoScene()
        {
            ...
            if (!AssetDatabase.IsValidFolder(DemoFolder))
                AssetDatabase.CreateFolder("Assets/Neo UI Framework", "Demo");
        ...
        private static void BuildMainView(RectTransform canvas)
        {
            ...
            CreateTitle(panel, "Neo UI Demo", 340f);
