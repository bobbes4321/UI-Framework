...
namespace Neo.UI.Editor
{
    ...
    public static class PresetFields
    {
        ...
        private static List<PresetField> BuildBuiltins() => new List<PresetField>
        {
            ...
            StringField("radiusUnit", e => e.radiusUnit, (e, v) => e.radiusUnit = v, p => p.radiusUnit, (p, v) => p.radiusUnit = v),
            FloatArrayField("cornerRadii", e => e.cornerRadii, (e, v) => e.cornerRadii = v, p => p.CornerRadiiOrNull, (p, v) => p.cornerRadii = v),
            NullableFloatField("borderWidth", e => e.borderWidth, (e, v) => e.borderWidth = v, p => p.BorderWidthOrNull, (p, v) => p.borderWidth = v ?? -1f),
            StringField("borderColor", e => e.borderColor, (e, v) => e.borderColor = v, p => p.borderColor, (p, v) => p.borderColor = v),
            NullableFloatField("softness", e => e.softness, (e, v) => e.softness = v, p => p.SoftnessOrNull, (p, v) => p.softness = v ?? -1f),
