// Neo UI procedural shape shader. One material serves every NeoShape in the project:
// all shape parameters arrive per-vertex (UV0-UV3 + tangent), packed by NeoShape.OnPopulateMesh.
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                // _MainTex rides the CanvasRenderer (NeoShape.mainTexture), white when no sprite —
