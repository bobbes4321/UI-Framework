...
{
    /// <summary>
    /// Beautification P4: Ring/Arc SDF shapes, the theme-riding spec gradient (NeoGradient),
    ...
    public class DepthAndShapeTests
    {
        ...
        public void RingAndArc_Generate_WithParams()
        {
            ...
            NeoShape ring = prefab.GetComponentsInChildren<NeoShape>(true)
            ...
            NeoShape arc = prefab.GetComponentsInChildren<NeoShape>(true)
        ...
        public void Gradient_RidesAEGradient_WithTokenRefs()
        {
            ...
            NeoGradient gradient = prefab.GetComponentsInChildren<NeoGradient>(true).FirstOrDefault();
            Assert.IsNotNull(gradient, "spec gradient must add an NeoGradient");
        ...
        public void RadialProgress_BuildsArcDial_WYSIWYG()
        {
            ...
            Assert.AreEqual(ShapeType.Ring, radial.GetComponent<NeoShape>().shape, "the track is a ring");
        ...
        public void Elevation_Recipe_DrivesCardAndHelper()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(level2.softness, shadow.GetComponent<NeoShape>().edgeSoftness);
                ...
                Assert.AreEqual(ElevationRecipe.Get(3).softness,
                    card.transform.Find(UIWidgetFactory.ShadowName).GetComponent<NeoShape>().edgeSoftness);
