...
{
    /// <summary>
    /// NeoShape mesh generation: the SDF shader gets every parameter through vertex channels, so
    ...
    public class NeoShapeTests
    {
        ...
        public void SetUp()
        {
            ...
            _shape = _go.AddComponent<NeoShape>();
        }
        ...
        {
            MethodInfo populate = typeof(NeoShape).GetMethod("OnPopulateMesh",
                BindingFlags.NonPublic | BindingFlags.Instance, null,
                new[] { typeof(VertexHelper) }, null);
            Assert.NotNull(populate, "NeoShape.OnPopulateMesh(VertexHelper) not found");
