...
namespace Neo.UI
{
    ...
    /// </code>
    /// </summary>
    [AddComponentMenu("Neo/UI/Containers/UI Popup")]
    public class UIPopup : UIContainer
    {
        ...
        [Tooltip("Image slots SetSprites/SetSprite write into (Image or NeoShape), hierarchy order")]
        ...
        {
            PopupDatabase database = NeoUISettings.instance != null ? NeoUISettings.instance.popupDatabase : null;
            if (database == null)
            {
                Debug.LogError("[Neo.UI] No popup database configured in NeoUISettings.");
                return null;
            }
            ...
            if (prefab == null)
            {
                Debug.LogError($"[Neo.UI] Popup '{popupName}' not found in the popup database.");
                return null;
            }
        ...
        public static UIPopup Get(GameObject prefab)
        {
            ...
            if (popup == null)
            {
                Debug.LogError($"[Neo.UI] Prefab '{prefab.name}' has no UIPopup component.");
                return null;
            }
        ...
        /// <summary> Assigns sprites to the indexed image slots (Image.sprite or NeoShape.sprite). </summary>
        ...
        public UIPopup SetSprite(int index, Sprite sprite)
        {
            ...
            switch (images[index])
            {
                ...
                case NeoShape shape: shape.sprite = sprite; break;
            }
            return this;
        }
        ...
        {
            string canvasName = NeoUISettings.instance != null ? NeoUISettings.instance.popupsCanvasName : "PopupsCanvas";
