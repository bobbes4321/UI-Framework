...
{
    /// <summary>
    /// Vertex-color gradient for any Graphic (Image, TMP text, NeoShape): multiplies a two-stop
    ...
    /// </summary>
    [ExecuteAlways]
    [AddComponentMenu("Neo/UI/Rendering/Gradient")]
    [RequireComponent(typeof(Graphic))]
    public class NeoGradient : BaseMeshEffect
    {
