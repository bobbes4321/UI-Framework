...
namespace Neo.UI.Menus
{
    ...
    /// </summary>
    [AddComponentMenu("Neo/UI/Menus/Menu Presenter")]
    public class MenuPresenter : MonoBehaviour
    {
        [Tooltip("The catalog to present.")]
        public MenuCatalog catalog;
        [Tooltip("Row prefab library; falls back to NeoUISettings.menuWidgets when unset.")]
        ...
        protected MenuWidgetLibrary Library =>
            library != null ? library : (NeoUISettings.instance != null ? NeoUISettings.instance.menuWidgets : null);
